...
export const genTask = (i:number) => {
  ...
  return {
    ...
    keyongkucun:faker.random.number({ min: 0, max: 19999 }),
    dairuku:faker.random.number({ min: 0, max: 19999 }),
    daichuku:faker.random.number({ min: 0, max: 19999 }),
    kucunliang:faker.random.number({ min: 0, max: 19999 }),
    caigoujia:faker.random.number({ min: 0, max: 19999 }),
    pifajia:faker.random.number({ min: 0, max: 19999 }),
    lingshoujia:faker.random.number({ min: 0, max: 19999 }),
  }
}
